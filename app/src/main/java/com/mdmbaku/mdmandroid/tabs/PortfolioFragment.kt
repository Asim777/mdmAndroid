...
class PortfolioFragment : Fragment(), IDataForFragment {
    ...
    override fun dataForFragment(jsonObject: JSONObject, requestType: Network.Companion.RequestType) {
        ...
        val portfolioPage: WpPage = gson.fromJson(portfolioPageStringReader, object : TypeToken<WpPage>() {}.type)
        val portfolioContent = portfolioPage.content.renderedContent
        ...
        for (i in 1 until rawPortfolioItemList.size) {
            ...
            val currentPortfolioTitle = portfolioItem.
                    substring(portfolioItem.indexOf("/\">", beginningOfTitle + 1) + 3,
            ...
            portfolioItemList.add(PortfolioItem(currentPortfolioTitle, currentPortfolioImageUrl,
        ...
        val portfolioAdapter =  PortfolioAdapter(portfolioItemList)
